...
<<<<<<< HEAD:src/tests/end2end_tests/FramebufferFormatsTest.cpp
// Use this to select which configurations (e.g. which renderer, which GLES major version) these tests should be run against.
ANGLE_TYPED_TEST_CASE(FramebufferFormatsTest, ES2_D3D9, ES2_D3D11_FL9_3, ES2_D3D11, ES3_D3D11);
=======
#include "test_utils/ANGLETest.h"

using namespace angle;
>>>>>>> google/master:src/tests/gl_tests/FramebufferFormatsTest.cpp
