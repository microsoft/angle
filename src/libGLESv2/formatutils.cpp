...
GLuint InternalFormat::computeRowPitch(GLenum type, GLsizei width, GLint alignment, GLint rowLength) const
{
...
GLuint InternalFormat::computeDepthPitch(GLenum type, GLsizei width, GLsizei height, GLint alignment, GLint rowLength) const
{
    return computeRowPitch(type, width, alignment, rowLength) * height;
}
