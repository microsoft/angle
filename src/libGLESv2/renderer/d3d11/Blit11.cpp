      ...
      mSwizzleCB(NULL)
{
    ...
    rasterDesc.DepthClipEnable = !mRenderer->getDisableDepthClipSupport(); // Disable depth clip if we can;
...
void Blit11::buildShaderMap()
{
    ...
    // These are the 2D shaders that will compile for D3D_FEATURE_LEVEL_9_3
    {
