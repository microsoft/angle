                                                     ...
                                                     BufferUsage usage, unsigned int bufferSize)
{
    ...
    switch (usage)
    {
      ...
      case BUFFER_USAGE_VERTEX_OR_TRANSFORM_FEEDBACK:
        ...
        bufferDesc->BindFlags = (renderer->getRendererCaps().maxTransformFeedbackSeparateAttributes == 0) ? D3D11_BIND_VERTEX_BUFFER : D3D11_BIND_VERTEX_BUFFER | D3D11_BIND_STREAM_OUTPUT;
